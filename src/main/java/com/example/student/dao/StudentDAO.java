...
public class StudentDAO implements StudentDAOInterface  {
    ...
    public Student findById(Long id) {
        Student student = ( Student )
                getCurrentSession (). createQuery ( "from Student where id="+id ). list ();
        return student ;
    }
    ...
    public Student findByName(String name) {
        Student student = ( Student )
                getCurrentSession (). createQuery ( "from Student where name="+name ). list ();
        return student ;
    }

    @Override
    public List<Student> findByMark(Integer mark) {
        List < Student > students = ( List < Student >)
                getCurrentSession (). createQuery ( "from Student where mark="+mark ). list ();
        return students ;
    }
